...
import './Sidebar.css'
import {MDBContainer,MDBNavbar,MDBNavbarBrand,MDBNavbarToggler,MDBIcon,MDBCollapse,MDBNavbarNav,MDBNavbarItem,MDBNavbarLink,MDBDropdown,MDBDropdownMenu,MDBDropdownToggle,MDBDropdownItem}
...
<header>
  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        >
        <a href="/classroom" class="list-group-item list-group-item-action py-2 ripple"
          ><i class="fas fa-users fa-fw me-3"></i><span>Add Classroom</span></a
        >
        <a href="/classes" class="list-group-item list-group-item-action py-2 ripple"
          ><i class="fas fa-school fa-fw me-3"></i><span>Classrooms</span></a
        >
      </div>
    </div>
  </nav>
  ...
  <nav id="main-navbar" class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container-fluid">
      ...
      {/* <!-- Brand --> */}
      <MDBNavbarBrand href='/'>Exam Manager</MDBNavbarBrand>
